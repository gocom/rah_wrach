...
p. The above would bring News section to the top and list Design as the last. If the field is left empty, all sections are present in the prompt, sorted in an alphabetical order.
